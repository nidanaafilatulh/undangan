                    ...
                    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h3 class="ms-6 card-title">Masa Aktif</h3>
                                        <div class="text-right">
                                            <h3 class="card-text">00 00 00 00</h3>
                                            <p class="card-text mb-0">Hari Jam Menit Detik</p>
                                        </div>
                                    </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body text-center">
                                <h4 class="card-text">Belum Ada Paket yang Aktif</h4>
                                <a href="#" class="btn btn-primary">Upgrade Paketmu Sekarang</a>
                            </div>
                        </div>
                    </div>
                </div>
